...
<div class="w-full min-h-screen flex items-center justify-center bg-black">
        <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div class="w-full text-7xl font-bold">
                <h1 class=" w-full md:w-2/3 text-white  footer-heading">You can’t out-sneak a sneaker."
            </h1>
            </div>
            ...
            <div className="footer-text ">
                <img className='footer-image' src='/assets/extra/Footer.png' ></img>
                  <p class="footer-caption w-full md:w-2/3 text-white text-sm">To ensure that all Wikipedia content is verifiable, anyone may question an uncited claim. If your work has been tagged
                </p>
            </div>
